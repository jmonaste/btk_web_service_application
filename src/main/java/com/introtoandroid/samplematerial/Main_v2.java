...
public class Main_v2 extends AppCompatActivity {
    ...
    private VehiculeBasicInformationMaterialAdapter adapter;
    private ArrayList<CardBTKVehiculeBasicInfo> cardsList = new ArrayList<>();
    private ArrayList<CardBTKVehiculeCompleteInfo> cardsListCompleteInfo = new ArrayList<>();

    //Habrá que estudiar cómo se maneja aquí la información
    private int[] colors;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*OBTENCIÓN DE LOS DATOS QUE VAN A ALIMENTAR EL RECYCLEVIEW*/
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == adapter.getItemCount()) {
            if (resultCode == RESULT_OK) {
                ...
                //Habrá que editar esta línea
                adapter.addCard("Vehicule code", "Vehicule name", "Vehicule registration number", "Vehicule type", 1);
            }
        } else {
    ...
    //Aquí está el método para iniciar las CardViews. Deberá conectarse al servidor para obtener los datos.
    private void fillCardViews() {
        RequestCompanyVehicles request = new RequestCompanyVehicles(getApplicationContext(), findViewById(android.R.id.content));
        request.execute();
    }
}
